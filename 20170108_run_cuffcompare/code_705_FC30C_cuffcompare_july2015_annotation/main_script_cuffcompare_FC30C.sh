...
# IMPORTANT: use the below qsub command to run from the projects code directory
# qsub -v my_script_name=main_script_cuffcompare_FC30C.sh -S /bin/bash main_script_cuffcompare_FC30C.sh

#
#  This script...
#		runs cuffcompare on cufflinks output from mouse Frontal Cortex 30 minute controls
#
...
OUTPUT_DATA_FOLDER="$PROJECT_FOLDER"/output_705_FC30C_cuffcompare_july2015_annotation"_"$RUN_ID
...
GTF1=/home/groups/simons/Joe/mouse_FC_30/FC_30_CK1_ATTCAGAA-GGCTCTGA_L00M_R1_001.cufflinks_de_novo/transcripts.gtf
GTF2=/home/groups/simons/Joe/mouse_FC_30/FC_30_CK2_ATTCAGAA-AGGCGAAG_L00M_R1_001.cufflinks_de_novo/transcripts.gtf
GTF3=/home/groups/simons/Joe/mouse_FC_30/FC_30_CK3_ATTCAGAA-TAATCTTA_L00M_R1_001.cufflinks_de_novo/transcripts.gtf
GTF4=/home/groups/simons/Joe/mouse_FC_30/FC_30_CK4_ATTCAGAA-CAGGACGT_L00M_R1_001.cufflinks_de_novo/transcripts.gtf
GTF5=/home/groups/simons/Joe/mouse_FC_30/FC_30_CK5_ATTCAGAA-GTACTGAC_L00M_R1_001.cufflinks_de_novo/transcripts.gtf
...
cuffcompare -V -o "$OUTPUT_DATA_FOLDER"/contained -C -s "$CHR_FA" -r "$REF_GTF" -R "$GTF1" "$GTF2" "$GTF3" "$GTF4" "$GTF5" 2> "$OUTPUT_DATA_FOLDER"/contained.log.txt
 
# only do contained # cuffcompare -V -o "$OUTPUT_DATA_FOLDER"/uncontained -s "$CHR_FA" -r "$REF_GTF" -R "$GTF1" "$GTF2" "$GTF3" "$GTF4" "$GTF5" 2> "$OUTPUT_DATA_FOLDER"/uncontained.log.txt
