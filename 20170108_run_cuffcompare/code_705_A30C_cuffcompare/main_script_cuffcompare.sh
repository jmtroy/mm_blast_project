...
# qsub -v my_script_name=main_script_cuffcompare.sh -S /bin/bash main_script_cuffcompare.sh
...
OUTPUT_DATA_FOLDER="$PROJECT_FOLDER"/output_705_A30C_cuffcompare"_"$RUN_ID
