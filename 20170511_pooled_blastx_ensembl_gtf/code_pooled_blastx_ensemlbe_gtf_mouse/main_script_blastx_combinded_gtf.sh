...
OUTPUT_DATA_FOLDER="$PROJECT_FOLDER"/output_pooled_blastx_ensembl_gtf"_"$RUN_ID
...
COMB_GTF=/home/groups/simons/Joe/mm_blast_project/input_data/RPKM_pooled_ensembl_gtf/denovo_pooled_ensembl_gtf_output/A30C_w_rpkm_counts.gtf
################# A30C_intERgenic ###########################
...
# FC30C
# TODO make sure the below input files are correct
COMB_GTF=/home/groups/simons/Joe/mm_blast_project/input_data/RPKM_pooled_ensembl_gtf/denovo_pooled_ensembl_gtf_output/FC30C_w_rpkm_counts.gtf
################# FC30C_intERgenic ###########################
# set grep var to find intERgenic exons
GREP_VAR='class_code "u"'
# set file prefix to name files as intRAgenic
...
# H30C
# TODO make sure the below input files are correct
COMB_GTF=/home/groups/simons/Joe/mm_blast_project/input_data/RPKM_pooled_ensembl_gtf/denovo_pooled_ensembl_gtf_output/H30C_w_rpkm_counts.gtf
################# H30C_intERgenic ###########################
# set grep var to find intERgenic exons
GREP_VAR='class_code "u"'
# set file prefix to name files as intRAgenic
