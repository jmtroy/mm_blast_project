...
OUTPUT_DATA_FOLDER="$PROJECT_FOLDER"/output_A30C_intRAgenic_blastx"_"$RUN_ID
...
COMB_GTF=/home/groups/simons/Joe/mm_blast_project/input_data/RPKM/output/A30C_w_rpkm_counts.gtf
