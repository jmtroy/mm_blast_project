...
# qsub -v my_script_name=main_script_cuffcompare_AC30C.sh -S /bin/bash main_script_cuffcompare_AC30C.sh

#
#  This script...
#		runs cuffcompare on cufflinks output from mouse Amygdala 30 minute controls
#
...
OUTPUT_DATA_FOLDER="$PROJECT_FOLDER"/output_705_A30C_cuffcompare_ensembl_annotation"_"$RUN_ID
...
GTF1=/home/groups/simons/Joe/mouse_A_30/A_30_CK1_ATTACTCG-TAATCTTA_L00M_R1_001.cufflinks_de_novo/transcripts.gtf
GTF2=/home/groups/simons/Joe/mouse_A_30/A_30_CK2_ATTACTCG-CAGGACGT_L00M_R1_001.cufflinks_de_novo/transcripts.gtf
GTF3=/home/groups/simons/Joe/mouse_A_30/A_30_CK3_ATTACTCG-GTACTGAC_L00M_R1_001.cufflinks_de_novo/transcripts.gtf
GTF4=/home/groups/simons/Joe/mouse_A_30/A_30_CK4_TCCGGAGA-TATAGCCT_L00M_R1_001.cufflinks_de_novo/transcripts.gtf
GTF5=/home/groups/simons/Joe/mouse_A_30/A_30_CK5_TCCGGAGA-ATAGAGGC_L00M_R1_001.cufflinks_de_novo/transcripts.gtf
...
# Change by Joe Troy 1/8/2017 do not run with the un-contained option 
#cuffcompare -V -o "$OUTPUT_DATA_FOLDER"/uncontained -s "$CHR_FA" -r "$REF_GTF" -R "$GTF1" "$GTF2" "$GTF3" "$GTF4" "$GTF5" 2> "$OUTPUT_DATA_FOLDER"/uncontained.log.txt
